...
def build_payload(horizon: int = 180, lookback: int = 45) -> dict:
    ...
    for _, r in board.iterrows():
        rows.append({
            ...
            "date_hi": _clean(r.get("catalyst_date_hi")),
            "date_source": _clean(r.get("date_source")),
            "guide_phrase": _clean(r.get("guide_phrase")),
            "verdict": r["verdict"],
            ...
            "offerings_24m": _clean(r.get("offerings_24m")),
            "dilution": _clean(r.get("dilution_label")),
            "runway_stale": bool(r.get("runway_stale")),
            "cash_asof": _clean(r.get("cash_asof")),
            "design": _clean(r.get("design_bucket")),
            "design_note": _clean(r.get("design_note")),
            "enrollment": _clean(r.get("enrollment")),
            "days_since_offering": _clean(r.get("days_since_offering")),
            "insider_tilt": _clean(r.get("insider_tilt")),
            "form4_filings": _clean(r.get("form4_filings")),
            "cluster_buy": bool(r.get("cluster_buy")) if pd.notna(r.get("cluster_buy")) else False,
            "senior_net_usd": _clean(r.get("senior_net_usd")),
